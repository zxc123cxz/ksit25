        ...
        <section class="content">
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <a href="/store/${ticketStore.id}/edit" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> 编辑</a>
                        <a class="btn btn-danger btn-sm delLink" rel="${ticketStore.id}" href="javascript:;"><i class="fa fa-trash">删除</i></a>
                    </div>
                </div>
                <div class="box-body">
                    <table class="table">
            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <a class="btn btn-danger btn-sm Lock" rel="${storeAccount.id}" href="javascript:;"><i class="fa fa-ban">禁用账号</i></a>
                        <a class="btn btn-primary btn-sm recover" rel="${storeAccount.id}" href="javascript:;"><i class="fa fa-pencil">恢复账号</i></a>
                    </div>
                </div>
                <div class="box-body">
                    <table class="table">
        ...
        $(function () {
            $(".Lock").click(function(){
                ...
                layer.confirm("确定要禁用吗",function (index) {
                    layer.close(index);
                    $.get("/store/"+id+"/lock").done(function (result) {
                        if(result.status == 'success') {
                            history.go(0);
                        } else {
                            layer.msg(result.message);
