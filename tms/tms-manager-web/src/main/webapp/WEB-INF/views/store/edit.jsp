            ...
            <div class="box">
                <div class="box-body">
                    <form method="post" id="saveForm">
                        <input type="hidden" id="storeManagerAttachment" name="storeManagerAttachment" value="${storeManagerAttachment}">
                        <input type="hidden" id="storeAttachment" name="storeAttachment" value="${storeAttachment}">
